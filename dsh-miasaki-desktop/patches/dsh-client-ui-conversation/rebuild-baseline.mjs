...
if (target === undefined || target === null || !existsSync(target)) {
  console.error('[baseline] 未找到已安装的 client.js（用 --target 指定，或设 MIASAKI_DSH_CONVERSATION_BUNDLE）')
  process.exit(2)
}
