...
| `baseline/client.original.js` | DSH **0.1.2-rc.1** 官方原版 client.js（137,701 B，SHA-256 `7ACF9736…`）。与安装目录的 `client.js.dsh-bak` 逐字节一致 |
| `baseline/client.patched.js` | 应用补丁后的产物（143,340 B，SHA-256 `18D114AC…`）。**黄金对照**：既是重建目标，也是升级后人工适配时的 diff 基准 |
