...
**2026-09-23 基线（全量 93 项检查，七线全 PASS；DSH 已实装 0.1.7-alpha.2，六个补丁全部重打、`EDITS` 零改）**：sidebar 10/10、canvas 11/11、fleet 15/15、desktop 18/18（含 6 个补丁自证）、ssh 12/12、dual-model 11/11、appearance 16/16。
